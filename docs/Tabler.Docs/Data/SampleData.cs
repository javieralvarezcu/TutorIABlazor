    ...
    public static class SampleData
    {
        public static List<Order> GeneratedOrders(int count)
        {
            ...
            for (int i = 1; i <= count; i++)
            {
                ...
                {
                    Customer = customer, Country = "Sweden", OrderDate = DateTimeOffset.Now.AddDays(-12),
                    GrossValue = rnd.Next(2000, 50000), DiscountPercentage = rnd.Next(10, 50),
        ...
        public static List<Order> GetOrders()
        {
            ...
            orders.Add(new Order
            {
                OrderStatus = OrderStatus.OnHold, Customer = odio, Country = "Sweden",
                OrderDate = DateTimeOffset.Now.AddDays(-232), GrossValue = 1400, DiscountPercentage = 12,
                OrderType = OrderType.Mail
            });
            orders.Add(new Order
            {
            ...
            {
                OrderStatus = OrderStatus.Cancelled, Customer = nascetur, Country = "Sweden",
                OrderDate = DateTimeOffset.Now.AddDays(-372), GrossValue = 44000, DiscountPercentage = 11,
                OrderType = OrderType.Phone
            });
            orders.Add(new Order
            {
                OrderStatus = OrderStatus.Active, Customer = nascetur, Country = "Sweden",
                OrderDate = DateTimeOffset.Now.AddDays(-410), GrossValue = 17000, DiscountPercentage = 5,
                OrderType = OrderType.Phone
            });
            ...
            orders.Add(new Order
            {
                ...
                OrderDate = DateTimeOffset.Now.AddDays(-60), GrossValue = 1400, DiscountPercentage = 12,
                OrderType = OrderType.Mail
            });
            orders.Add(new Order
            {
            ...
            {
                OrderStatus = OrderStatus.Active, Customer = justo, Country = "Spain",
                OrderDate = DateTimeOffset.Now.AddDays(-200), GrossValue = 3000, DiscountPercentage = 17,
                OrderType = OrderType.Web
            });

            orders.Add(new Order
            {
                OrderStatus = OrderStatus.OnHold, Customer = ani, Country = "France",
                OrderDate = DateTimeOffset.Now.AddDays(-17), GrossValue = 2134, DiscountPercentage = 10,
                OrderType = OrderType.Phone
            });
            orders.Add(new Order
            {
                OrderStatus = OrderStatus.Active, Customer = ani, Country = "France",
                OrderDate = DateTimeOffset.Now.AddDays(-27), GrossValue = 11345, DiscountPercentage = 12,
                OrderType = OrderType.Phone
            });
            orders.Add(new Order
            {
                OrderStatus = OrderStatus.Shipped, Customer = ani, Country = "France",
                OrderDate = DateTimeOffset.Now.AddDays(-124), GrossValue = 17002, DiscountPercentage = 32,
                OrderType = OrderType.Mail
            });

            orders.Add(new Order
            {
                OrderStatus = OrderStatus.Active, Customer = cali, Country = "France",
                OrderDate = DateTimeOffset.Now.AddDays(-10), GrossValue = 77000, DiscountPercentage = 17,
                OrderType = OrderType.Web
            });
            orders.Add(new Order
            {
                OrderStatus = OrderStatus.Shipped, Customer = cali, Country = "France",
                OrderDate = DateTimeOffset.Now.AddDays(-110), GrossValue = 120000, DiscountPercentage = 23,
                OrderType = OrderType.Web
            });
            orders.Add(new Order
            {
                OrderStatus = OrderStatus.Active, Customer = cali, Country = "France",
                OrderDate = DateTimeOffset.Now.AddDays(-243), GrossValue = 44000, DiscountPercentage = 8,
                OrderType = OrderType.Web
            });
